package old
{
  ...
  import flash.utils.ByteArray;
	...
	{
		private static const DEFAULT_BITMAP_DATA:BitmapData = new BitmapData( 256, 256, false, 0xFFFFFF );
		...
		*/
		override arcane function resolveDependencyFailure(resourceDependency:ResourceDependency):void
		{
			var lm:LoadedMaterial = new LoadedMaterial();
			lm.materialID = resourceDependency.id;
			lm.texture = new BitmapTexture( DEFAULT_BITMAP_DATA );
		...
		*/
		private function translate() :void
		{
			...
			for (var g : uint = 0; g < numGroups; ++g) {
				...
				bmMaterial = new TextureMaterial( new BitmapTexture( DEFAULT_BITMAP_DATA ) );
